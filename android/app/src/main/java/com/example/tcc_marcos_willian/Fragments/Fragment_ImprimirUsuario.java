...
public class Fragment_ImprimirUsuario extends Fragment {
    ...
    private void salvarImpressaoFirebaseDatabase(UploadTask.TaskSnapshot taskSnapshot) {
        String tipoUsuario = tipoUsuarioSharedPreference();
        ...
        reference_impressao.child("imprimir").child(tipoUsuario).child(reference_impressao.push().getKey()).setValue(upload);
